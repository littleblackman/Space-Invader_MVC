...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 01 août 2018 à 00:01
...
--
/* Création de bdd nommée membre */ 

/* Création d'une premiere table membre */ 
...
/* Création d'une deuxiéme table nommée scoremembre */
/* la clé primaire doit etre présente dans la deuxiéme table */ 
...
CREATE TABLE IF NOT EXISTS `scoremembre` (
  ...
  KEY `contrainteid` (`id`)  /* Clé etrangére */ 
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;


/*  Contrainte qui défini la clé etrangére */ 

ALTER TABLE `scoremembre`
  ADD CONSTRAINT `contrainteid` FOREIGN KEY (`id`) REFERENCES `membres` (`id`);
COMMIT;
